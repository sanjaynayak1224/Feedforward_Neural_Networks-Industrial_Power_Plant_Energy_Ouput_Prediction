...
The dataset used in this project is the **Combined Cycle Power Plant (CCPP)** dataset, originally collected by researchers _Heysem Kaya_ and _Pinar Tüfekci_ and hosted on the **UCI Machine Learning Repository**.
...
```bash
git clone https://github.com/sanjaynayak1224/Feedforward_Neural_Networks-Industrial_Power_Plant_Energy_Output_Prediction.git
